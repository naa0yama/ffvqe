...
def _get_default_patterns() -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "outfile": {
                "base": [
                    {"type": "Anime", "option": "-crf 43"},
                    {"type": "Nature", "option": "-crf 32"},
                ],
                "options": [""],
            },
            "hwaccels": "",
        ...
        },
        {
            ...
            "outfile": {
                "base": [
                    {"type": "Anime", "option": "-global_quality 29 -look_ahead 1"},
                    {"type": "Nature", "option": "-global_quality 26 -look_ahead 1"},
                ],
                "options": ["-bf 15 -refs 8"],
            },
            "hwaccels": "-hwaccel_output_format qsv",
